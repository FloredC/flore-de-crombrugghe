...
//
// The presenting arm gestures LEFT, into the gap beside the bubble rather than
// at anything -- on the homepage it points at the breadcrumb, and there is no
// breadcrumb here. Kept unflipped anyway: flipping it would aim the gesture at
// the bubble's own tail, and Flore approved this exact pose for the placeholder.
//
...
export default function AvatarNote({ body, align = 'end' }) {
  return (
    ...
    >
      ...
      <AvatarPresentingIdle width={GUIDE_AVATAR_WIDTH} className="shrink-0" />
