...
export const LINK_CLASS = `text-action-link-foreground hover:text-action-link-foreground-hover hover:underline active:text-action-link-foreground-pressed active:underline ${FOCUS_CLASS}`
