...
<!-- takeaways.note -->
> **Guide:** I tested twice: think-aloud sessions with four designers right after building it, then these numbers at a Friends of Figma event seven months on. The AI landscape had changed, and expectations with it.

<!-- takeaways.items[0].title -->
## It has to live where the work already happens.

<!-- takeaways.items[0].body[0] -->
...
<!-- takeaways.items[0].chart.caption -->
*Caption: Barriers to adoption*

<!-- takeaways.items[1].title -->
## Good UX couldn't compensate for generic AI.

<!-- takeaways.items[1].body[0] -->
...
<!-- takeaways.items[1].chart.caption -->
*Caption: Tool quality*

<!-- takeaways.items[2].title -->
## The biggest blocker is the one no tool reaches.

<!-- takeaways.items[2].body[0] -->
...
<!-- takeaways.items[2].chart.caption -->
