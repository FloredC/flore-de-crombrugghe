# Sinomocene, China's reach in nine datasets

<!-- Extracted from src/content/case-studies/sinomocene.js by scripts/copy.mjs.
     A VIEW, not a source: edit the .js, then re-run `npm run copy sinomocene`.
...
*Caption: Countries with the most or least Chinese economic presence in a region, 2010-2017 aggregate.*
