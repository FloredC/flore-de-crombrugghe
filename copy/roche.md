# Roche Icon System, a construction kit for complex science.

<!-- Extracted from src/content/case-studies/roche.js by scripts/copy.mjs.
     A VIEW, not a source: edit the .js, then re-run `npm run copy roche`.
